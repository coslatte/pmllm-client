...
const ChatComposer = ({ inputValue, isResponding, onInputChange, onSubmit }: ChatComposerProps) => {
  return (
    <form onSubmit={onSubmit} className="sticky bottom-0 mx-auto w-full max-w-5xl px-6 pb-8">
      <div className="rounded-3xl border border-zinc-200 bg-white px-6 py-4 shadow-2xl shadow-blue-100/50">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-5 py-2 text-sm font-semibold text-white transition hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-50"
          >
